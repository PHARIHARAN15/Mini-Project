...
if(isset($_POST['add_view'])){
   ...
   if(mysqli_num_rows($select_view_name) > 0){
      $message[] = 'Photo name already added';
   }else{
...
if(isset($_POST['update_view'])){
   ...
   mysqli_query($conn, "UPDATE `view` SET name = '$update_name' WHERE id = '$update_p_id'") or die('query failed');
   ...
   if(!empty($update_image)){
      if($update_image_size > 2000000){
         ...
         mysqli_query($conn, "UPDATE `view` SET image = '$update_image' WHERE id = '$update_p_id'") or die('query failed');
...
<section class="add-products">
   ...
   <h1 class="title">Newly Lanched</h1>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="admin_photo.php?update=<?php echo $fetch_view['id']; ?>" class="option-btn">Update</a>
         <a href="admin_photo.php?delete=<?php echo $fetch_view['id']; ?>" class="delete-btn" onclick="return confirm('delete this photo?');">Delete</a>
      </div>
      <?php
         }
      }else{
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="update" name="update_view" class="btn">
